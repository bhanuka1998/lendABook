        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    $results = mysqli_query($db, " SELECT `bBorrow_id`, `user_id`, `user_email`, book.name, `return_date`, `status` FROM `book_borrowings` INNER JOIN book ON book_borrowings.book_id = book.id; ");
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($results)) { ?>
                                <tr>
                                    ...
                                    <td><a href="php/updateBookStatus.php?id=<?php echo $row["bBorrow_id"]; ?>">Update</i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                </div>
