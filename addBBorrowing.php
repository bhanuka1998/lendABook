    ...
    <div class="forms">
      <div class="form-content">
        <div class="login-form">
          <div class="title">Add Book Borrowing</div>
          <form method="post" action="php/addBBorrowing.php">
            <div class="input-boxes">
              ...
              <div class="input-boxes">
                <div class="input-box">
                  ...
                  <input type="text" name="book_id" value="" placeholder="Enter Book ID" required>
                </div>
              </div>
