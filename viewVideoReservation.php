        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    $results = mysqli_query($db, " SELECT reservationvideo.id, video.video_name, tbl_user.email FROM `reservationvideo` INNER JOIN video ON reservationvideo.video_id = video.id INNER JOIN tbl_user ON reservationvideo.user_id = tbl_user.id ");
