        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    $results = mysqli_query($db, " SELECT reservationbook.id, book.name, tbl_user.first_name FROM `reservationbook` INNER JOIN book ON reservationbook.book_id = book.id INNER JOIN tbl_user ON reservationbook.user_id = tbl_user.id ");
